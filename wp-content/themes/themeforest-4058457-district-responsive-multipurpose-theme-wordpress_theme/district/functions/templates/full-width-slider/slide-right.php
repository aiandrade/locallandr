...
<li <?php echo ($ag_slide['transition']) ? 'data-transition="' . $ag_slide['transition'] .'"' : 'data-transition="fade"' ?> data-slotamount="7" <?php echo ($ag_slide['slide_link'] && $ag_slide['slide_link'] != '') ? 'data-link="' . ag_addhttp($ag_slide['slide_link']) .'"' : '' ?> class="<?php echo 'slide-' . get_the_ID(); ?>">
    ...
    <!-- Slide Video -->
	<div class="caption sfr homeimage vcenter leftside media" data-x="0" data-y="center" data-speed="1200" data-start="700" data-easing="easeOutCubic">
    ...
    <div class="caption sfr homeheadline rightside vcenter" data-x="525" data-y="center" data-speed="1200" data-start="<?php echo (has_post_thumbnail() || ($ag_slide['video'] && $ag_slide['video'] != '')) ? '1200' : '700'; ?>" data-easing="easeOutCubic"><div class="clear"></div>
